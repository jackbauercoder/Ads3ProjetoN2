...
public class TelaReserva extends javax.swing.JFrame {
    ...
    public TelaReserva() {
        ...
        try {
            ...
            PReserva rdao = new PReserva(reserva_db);
            rdao.atualizarReservasExpiradas();
            
            //carrega comboboxes
            PCliente cdao = new PCliente(cliente_db);
            PExemplar edao = new PExemplar(exemplar_db);
    ...
    private void jButtonEfetuarEmprestimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEfetuarEmprestimoActionPerformed
        ...
        try {
            ...
            if(!jLabelReservaID .getText().isEmpty()) {
                ...
                //Cria uma instancia de PCliente
                PCliente cdao = new PCliente(cliente_db);
                ...
                //Cria uma instancia de PEmprestimo
                PEmprestimo empdao = new PEmprestimo(emprestimo_db);
                
                //Cria uma instancia de PExemplar
                PExemplar edao = new PExemplar(exemplar_db);
