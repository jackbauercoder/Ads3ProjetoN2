...
public class TelaAutor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jTextFieldBuscaAutor, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void jButtonCadastrarAutorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarAutorActionPerformed
        ...
        try {
            ...
            if (!jTextFieldAutorNome.getText().isEmpty()) {
                ...
                autor.setNome(jTextFieldAutorNome.getText());
                NAutor nAutor = new NAutor();

                nAutor.incluir(autor);
    ...
    private void jButtonBuscaAutorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscaAutorActionPerformed
        // TODO add your handling code here:
        try {
            if (jTextFieldBuscaAutor.getText().isEmpty()) {
                throw new Exception("Favor digitar o nome desejado para buscar.");
            } else {
                Autor autor = new Autor();
                NAutor nAutor = new NAutor();
                autor = nAutor.consultar(Integer.parseInt(jTextFieldBuscaAutor.getText()));
                jTextFieldAutorNome.setText(autor.getNome());
                jLabelAutorID.setVisible(true);
                jLabelAutorID.setText(Integer.toString(autor.getId()));
    ...
    private void jButtonAlterarAutorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarAutorActionPerformed
        ...
        try {
            ...
            if (!jLabelAutorID.getText().isEmpty()) {
                autor.setId(idAutor);
            }
